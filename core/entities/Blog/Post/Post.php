...
class Post extends ActiveRecord
{
    ...
    public static function create($categoryId, $userId, $viewed, $title, $description, $content, Meta $meta): self
    {
        $post = new static();
    ...
    public function edit($categoryId, $userId, $viewed, $title, $description, $content, Meta $meta): void
    {
        ...
        return [
            ...
            [
                ...
                'thumbs' => [
                    ...
                    'blog_list' => ['width' => 1000, 'height' => 550],
