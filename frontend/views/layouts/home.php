            ...
            <div id="slideshow0" class="owl-carousel" style="opacity: 1;">
                <div class="item" >
                    <a href="index.php?route=product/product&amp;path=57&amp;product_id=49"><img
                            src="http://static.shatilin.com/cache/banners/shatilin1.jpg"
                            alt="iPhone 6" class="img-responsive"></a>

                </div>
                <div class="item">
                    <img src="http://static.shatilin.com/cache/banners/shatilin2.jpg"
                         alt="MacBookAir" class="img-responsive"/>
                </div>
                <div class="item">
                    <img src="http://static.shatilin.com/cache/banners/shatilin3.jpg"
                         alt="MacBookAir" class="img-responsive"/>
                </div>
            </div>
        </div>
